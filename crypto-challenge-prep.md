...
- [x] **Cross-module symbol resolution.** Extend the import branch in `checker.ts` so a source import looks up the symbol in the imported module's exported decls and unifies the signature.
...
- [x] [blake2b.ents](examples/crypto/blake2b.ents) compiles and produces correct hashes.
