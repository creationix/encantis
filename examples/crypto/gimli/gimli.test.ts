...
const wasmPath = new URL('./gimli.wasm', import.meta.url).pathname
const wasmExists = existsSync(wasmPath)

describe.skipIf(!wasmExists)('gimli', () => {
  test('gimli permutation on zero state', async () => {
    const { gimli } = await import('./gimli.js')
  ...
  test('gimli permutation on test vector', async () => {
    const { gimli } = await import('./gimli.js')
  ...
  test('gimli hash empty string', async () => {
    const { gimliHash, toHex } = await import('./gimli.js')
  ...
  test('gimli hash produces different outputs for different inputs', async () => {
    const { gimliHash, toHex } = await import('./gimli.js')
  ...
  test('gimli hash longer input', async () => {
    const { gimliHash } = await import('./gimli.js')
