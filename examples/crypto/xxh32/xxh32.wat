...
(local.get $seed) (return)
  
)
(func $xxh32 (param $data_ptr i32) (param $data_len i32) (param $seed i32) (result i32)
  (local $ptr i32)
  (local $len i32)
  (local $last i32)
  (local $v1 i32)
...
(if  (i32.ge_u (local.get $len) (i32.const 16)) (then (local.set $v1 (i32.add (i32.add (local.get $seed) (i32.const 2654435761)) (i32.const 2246822519)))
...
(local.set $ptr (i32.add (local.get $ptr) (i32.const 4)))
(br_if $break (i32.gt_u (local.get $ptr) (local.get $limit)))
      (br $continue)
    )
  )
(local.set $h32 (i32.add (i32.add (i32.add (i32.rotl (local.get $v1) (i32.const 1)) (i32.rotl (local.get $v2) (i32.const 7))) (i32.rotl (local.get $v3) (i32.const 12))) (i32.rotl (local.get $v4) (i32.const 18))))) (else (local.set $h32 (i32.add (local.get $seed) (i32.const 374761393)))))
(local.set $h32 (i32.add (local.get $h32) (local.get $len)))
(block $break
    (loop $continue
      (br_if $break (i32.eqz (i32.le_u (i32.add (local.get $ptr) (i32.const 4)) (local.get $last))))
      (local.set $h32 (i32.add (local.get $h32) (i32.mul (i32.load (local.get $ptr)) (i32.const 3266489917))))
(local.set $h32 (i32.mul (i32.rotl (local.get $h32) (i32.const 17)) (i32.const 668265263)))
(local.set $ptr (i32.add (local.get $ptr) (i32.const 4)))
      (br $continue)
    )
  )
(block $break
    (loop $continue
      (br_if $break (i32.eqz (i32.lt_u (local.get $ptr) (local.get $last))))
      (local.set $h32 (i32.add (local.get $h32) (i32.mul (i32.load8_u (local.get $ptr)) (i32.const 374761393))))
(local.set $h32 (i32.mul (i32.rotl (local.get $h32) (i32.const 11)) (i32.const 2654435761)))
